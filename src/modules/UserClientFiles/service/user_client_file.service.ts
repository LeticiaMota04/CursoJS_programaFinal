...
class UserClientFilesService {
    public async create(paramsId: string, tokenUserId: string, name: string, date: Date, description: string, file: string) {
    ...
    public async listAll(paramsId: string, paramsYear: string, tokenUserId: string) {
