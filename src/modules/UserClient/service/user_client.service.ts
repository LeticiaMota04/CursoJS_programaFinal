...
class UserClientService {
    public async create(tokenUserId: string, name: string, email: string, phone: string) {
    ...
    public async update(name: string, email: string, phone: string, paramsId: string, tokenUserId: string) {
        const findUserClient = await prismaConnect.userClient.findFirst({
            where: {
                id: paramsId,
                userId: tokenUserId,
    ...
    public async delete(paramsId: string, tokenUserId: string) {
        ...
        UtilsFileUser.deleteFolderUser([deleteUserClient.userId, deleteUserClient.id]);
